...
const AccordionIconSvg = ({ classRotate = "rotate-180" }) => (
    <svg
        className={`fill-primary stroke-primary duration-200 ease-in-out dark:fill-white dark:stroke-white ${classRotate}`}
        width="18"
        height="10"
        viewBox="0 0 18 10"
        fill="none"
...
export default AccordionIconSvg;