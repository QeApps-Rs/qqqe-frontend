...
const ArrowMasterFormSvg = ({ isActive, isHidden }) => {
    return (
        <svg
            className={`fill-primary ${isHidden ? "hidden" : ""} stroke-primary duration-200 ease-in-out dark:fill-white dark:stroke-white w-6 h-6 transform ${isActive ? "rotate-180" : "rotate-0"}`}
            viewBox="0 0 18 10"
...
export default ArrowMasterFormSvg;
