...
const AllPageStartOverviewPage = ({ category, priorityCount }) => {
  ...
  return (
    <>
      <div className="bg-[#000000] rounded-md px-4 md:px-6 py-4 animate-fadeIn max-w-full mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
              <div className="sm:col-span-12 md:col-span-12">
                ...
                <p className="text-sm sm:text-xl font-normal text-white leading-relaxed mt-3">
                  Analyze customers data, including demographics,Analyze
                  customers data, including demographics,Analyze customers data,
                  including demographics,Analyze customers data, including
                  demographics,
                </p>
                ...
                <div className="flex flex-wrap items-center mt-4 sm:mt-6 gap-2 sm:gap-4">
                  <Link to={category.url} className=" w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="block w-full sm:w-auto px-3 min-h-[50px] sm:min-h-[60px] sm:px-4 py-2 sm:py-4 font-bold bg-blue-600 text-white rounded-md shadow-lg hover:bg-blue-700 transition-colors duration-300 hover:shadow-xl transform hover:scale-105"
                  >
                    <i
