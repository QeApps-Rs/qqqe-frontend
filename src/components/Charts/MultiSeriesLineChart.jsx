...
const MultiSeriesLineChart = ({ chartTitle, orderData, dateRange, isToday, xAxisTitle }) => {
    ...
    useEffect(() => {
        if (orderData && dateRange && Object.keys(orderData).length > 0) {
            ...
            if (isToday) {
                ...
                salesValues = Object.values(orderData).map(data => parseFloat(data.total_order_count));
