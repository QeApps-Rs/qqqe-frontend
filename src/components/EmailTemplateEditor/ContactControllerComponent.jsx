                ...
                <div className={inputControllerFieldClass}>
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleEmailTemplateChange({ heading: e.target.value }, 'contact_banner_style')
                      }
                      name="heading"
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleEmailTemplateChange({ email: e.target.value }, 'contact_banner_style')
                      }
                      name="email"
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleEmailTemplateChange({ number: e.target.value }, 'contact_banner_style')
                      }
                      name="number"
