    ...
    <>
      <div className="col-span-12 xl:col-span-12">
        <div className="p-4 border-t border-white">
          <div className="p-4  bg-white shadow-default rounded-lg">
            <div className="mb-4 border-b border-black pb-5">
              ...
              <Radio
                ...
                onChange={(value) =>
                  handleTargetingAndBehaviourState("display.timing.type", value)
                }
                defaultValue={targetingAndBehavior?.display?.timing?.type}
              />
              {targetingAndBehavior?.display?.timing?.type == "on_rules" && (
            ...
            <div className="mb-4 border-b border-black">
              ...
              <div className="mb-4.5 mt-6">
                <Checkbox
                  ...
                  checked={targetingAndBehavior?.display?.frequency?.validation}
                  onChange={() =>
                    handleTargetingAndBehaviourState(
            ...
            <div className="mb-4 border-b border-black">
              ...
              <div className="mb-4.5 mt-6">
                <Checkbox
                  ...
                  label="On desktop"
                  checked={
                    targetingAndBehavior?.display?.devices?.click_outside_close
                      ?.on_desktop
                  }
                  onChange={() =>
                    handleTargetingAndBehaviourState(
              ...
              <label className="mb-2.5 block text-lg ">
                <div className="mb-6">
                  <DropDown
                    ...
                    selectedValue={targetingAndBehavior?.targeting?.visitors}
